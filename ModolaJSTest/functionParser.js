...
Modola.defineCore('parseFuncHeader', (tokens, i) => {
  ...
  if (!Modola.keywords.modifiers.scopeModifiers.includes(scope))
    throw "Expect scope specifier for function declaration";

  const name = tokens[i++].value;
  if (tokens[i++].value !== "(")
    throw "Expected '(' in functinon declaration";
...
Modola.defineCore('parseFuncBlock', (tokens, i) => {
  ...
  if (tokens[i++].value !== "{")
    throw "Expect  '{' after function header";
...
Modola.defineCore("parseFuncCall", (tokens, i) => {
  ...
  if (tokens[i++] !== "(")
    throw "Expected () for function call";
